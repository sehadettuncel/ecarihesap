...
class GelirOlustur extends StatefulWidget {
  const GelirOlustur({Key key}) : super(key: key);

  @override
  _GelirOlusturState createState() => _GelirOlusturState();
}

class _GelirOlusturState extends State<GelirOlustur> {
  var api = new Api();
  var loaded = false;
  var response;
  ...
  submit() async {
    ...
    var res = await api.post('/incomes', data);
  ...
  calculatePrices () {
    ...
    for(var i = 0; i < servicesList.length; i++) {
      var price = double.parse(servicesList[i]['price'].text.length > 0 ? servicesList[i]['price'].text : '0');
      var piece = double.parse(servicesList[i]['piece'].text.length > 0 ? servicesList[i]['piece'].text : '0');
      var discount = double.parse(servicesList[i]['discount'].text.length > 0 ? servicesList[i]['discount'].text : '0');
      var tax = double.parse(servicesList[i]['tax'].text.length > 0 ? servicesList[i]['tax'].text : '0');
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text("Gelir Kaydı Oluştur",
                                ...
                                child: DropdownButton(
                                  ...
                                  items: response != null
                                      ? response["clients"]
                                          ...
                                          return DropdownMenuItem<String>(
                                            value: "${valueItem["id"]}",
                                            child: Text(valueItem["full_name"],style: TextStyle(color: Colors.black)),
                                          );
                                        }).toList()
                                      : null,
                                ),
                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: DropdownButton(
                                        ...
                                        underline: SizedBox(),
                                        style: TextStyle(fontSize: 16),
                                        value: servicesList[index]['service_id'].text,
                                        onChanged: (newValue) {
                                          setState(() {
                                            servicesList[index]['service_id'].text =
                                                newValue;
                                          });
                                        },
                                        items: response == null
                                            ? <DropdownMenuItem<String>>[].toList()
                                            : response["services"]
                                                .map<DropdownMenuItem<String>>(
                                                    (valueItem) {
                                                return DropdownMenuItem<String>(
                                                  value: '${valueItem["id"]}',
                                                  child: new Text(valueItem["name"],
                                  ...
                                  child: FlatButton(
                                    onPressed: () {
                                      setState(() {
                                        servicesList.add({
                                          'service_id':
                                              new TextEditingController(text: response['services'][0]['id']),
                                          'price':
