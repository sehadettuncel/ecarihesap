...
class BorcOlustur extends StatefulWidget {
  const BorcOlustur({Key key}) : super(key: key);

  @override
  _BorcOlusturState createState() => _BorcOlusturState();
}

class _BorcOlusturState extends State<BorcOlustur> {
  var api = new Api();
  var loaded = false;
  var response;
  ...
  DateTime _dateTimeFirst, _dateTimeLast;
  ...
  submit() async {
    ...
    var data = {
      ...
      "price" : price.text,
      'first_payment_date': getTextFirst(),
      "last_payment_date":getTextLast(),
    };
    

    var res = await api.post('/debts', data);
    print(res.body);
